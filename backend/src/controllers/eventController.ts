...
const createEventSchema = z.object({
  ...
  startDate: z.iso.datetime("Fecha de inicio inválida"),
  endDate: z.iso.datetime("Fecha de fin inválida"),
...
export const getAllEvents = async (
  ...
  try {
    ...
    if (upcoming === "true") {
      query = query.where(
        and(eq(events.status, "published"), gte(events.startDate, new Date()))
      );
    }
